...
<body>
    ...
    <div class="login-box">
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div class="user-box">
                <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus style="background: transparent; color: white; border-bottom: 1px solid white;" />
                <label for="name">Nama</label>
            </div>
            <div class="user-box">
                <input id="email" type="email" name="email" value="{{ old('email') }}" required style="background: transparent; color: white; border-bottom: 1px solid white;" />
                <label for="email">Email</label>
            </div>
            <div class="user-box">
                <input id="password" type="password" name="password" required autocomplete="new-password" style="background: transparent; color: white; border-bottom: 1px solid white;" />
                <label for="password">Password</label>
            </div>
            <div class="user-box">
                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" style="background: transparent; color: white; border-bottom: 1px solid white;" />
